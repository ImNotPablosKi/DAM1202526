...
<template>
  ...
  <ul>
    <li v-for="estudiante in estudiantes">
  ...
  <h2>V-For CON V-If: Productos con valor MAYOR a 50.</h2>

  <ul>

    <!-- Debemos usar otro template pq el IF tiene preferencia -->
    <template v-for="p in productos">
