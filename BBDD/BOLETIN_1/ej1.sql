-- Ejercicio 1 Boletín UD5, Pablo Miguel
...
ALTER TABLE consultas DROP CONSTRAINT ck_precio_consultas;

ALTER TABLE consultas ADD CONSTRAINT ck_precio_consultas CHECK(precio<=1000);

ALTER TABLE medicos ADD CONSTRAINT ck_email_unique UNIQUE (email);